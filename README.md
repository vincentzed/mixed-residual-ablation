...
![loss difference by learning rate](loss_difference_by_learning_rate.svg)
...
![validation loss by learning rate](val_loss_by_learning_rate.svg)

![training loss at 3e-3](training_curve_at_best_lr.svg)
